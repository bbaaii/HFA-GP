...
class FaceReconModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--bfm_folder', type=str, default='/apdcephfs_cq2/share_1290939/kitbai/eg3d-pose-detection-main-master/BFM')
    ...
    def compute_visuals(self):
        with torch.no_grad():
            ...
            output_vis = self.input_img # (1 - self.pred_mask) * self.input_img #+self.pred_face * self.pred_mask +
