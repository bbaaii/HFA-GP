...
cmd = "python3.6 /eg3d-pose-detection/batch_mtcnn.py"
...
cmd = "python3.6 /eg3d-pose-detection/smooth.py"
...
cmd = "python3.6 /eg3d-pose-detection/test.py"
input_flag = " --img_folder=" + args.input_dir
...
cmd = "python3.6 /eg3d-pose-detection/crop_images.py"
...
cmd = "python3.6 /eg3d-pose-detection/3dface2idr.py"
...
print("Transforming...")
cmd = "python3.6 /eg3d-pose-detection/camera2label.py"
input_flag = " --in_root " + args.input_dir
cmd += input_flag
# subprocess.run([cmd], shell=True, check=True)
os.system(cmd)
