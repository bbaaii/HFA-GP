...
def read_data(im_path, lm_path, lm3d_std, to_tensor=True, rescale_factor=466.285): 
    ...
    # im_high.save(os.path.join('/apdcephfs_cq2/share_1290939/kitbai/LIA-3d/datasets/our_dataset/test/3', 'crop_1024', 'imagehigh.png'))
    if to_tensor:
...
# python test.py --epoch 20 --img_folder test_images/ --gpu_ids 0